/// <mls fileReference="_102039_/l2/controleChamados/web/desktop/page11/registrarComentarioChamado.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "registrarComentarioChamado",
  "variant": "page11",
  "actor": "atendente",
  "cases": [
    {
      "id": "qryLocateChamado.ok",
      "routine": "controleChamados.registrarComentarioChamado.qryLocateChamado",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
    ...
    {
      "id": "cmdRegisterComentario.ok",
      "routine": "controleChamados.registrarComentarioChamado.cmdRegisterComentario",
      "params": {
        "atendenteId": "<seedRef>",
        "chamadoId": "<seedRef>",
        "conteudo": "<seedValue>"
    ...
    {
      "id": "cmdRegisterComentario.conteudo.required",
      "routine": "controleChamados.registrarComentarioChamado.cmdRegisterComentario",
      "params": {
        "atendenteId": "<seedRef>",
        "chamadoId": "<seedRef>"
    ...
    },
    {
      ...
      "routine": "controleChamados.registrarComentarioChamado.qryAtendentePicker",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "array",
